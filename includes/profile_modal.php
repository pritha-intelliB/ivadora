        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-3 control-label">Event</label>

                    <div class="col-sm-9">
                      <input type="text" disabled="disabled" class="form-control" id="eventname" name="eventname" value="<?php echo $user['event_name']; ?>">
                    </div>
                </div>
                <hr>
