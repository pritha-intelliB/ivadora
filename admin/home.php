...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php if(isset($_SESSION['type'])&&$_SESSION['type']==1){?>Admin<?php }else{?>Seller<?php }?> Dashboard
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="small-box bg-green">
            <div class="inner">
			  ...
			  if($_SESSION['type']=='1'){
				...
				$stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM products WHERE seller_id='".$_SESSION['sellers']."'");  
			  }
                $stmt->execute();
                $prow =  $stmt->fetch();
