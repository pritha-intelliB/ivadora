    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b><?php if(isset($_SESSION['type'])&&$_SESSION['type']==1){?>Admin<?php }else{?>Seller<?php }?> Profile</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="phone" name="phone" value="<?php echo $admin['contact_info']; ?>">
                  	</div>
                </div>
                <div class="form-group">
